...
public class JobTrackingIT {
    ...
    public void outOfOrderProgressReportingTest () throws Exception {
        ...
        jobTrackingWorkerReporter.reportJobTaskProgress("Test.1",1);
        jobTrackingWorkerReporter.reportJobTaskProgress("Test.1",100);
        jobTrackingWorkerReporter.reportJobTaskProgress("Test.1",2);
        jobTrackingWorkerReporter.reportJobTaskProgress("Test.1",3);
